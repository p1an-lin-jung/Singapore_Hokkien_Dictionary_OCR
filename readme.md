...
| 词典正文 | 第 67–366 页（300 页） | `main_pages/` | `dictionary_ocr/3_词典正文.txt` |
...
随仓库附带一个桌面查阅器，把 PDF 原页和词典正文（TXT）对照展示，查起来比翻文件方便：
...
- 左边显示 PDF 页面（可翻页、跳转页码、缩放），右边显示该页解析出的词条（词头、音标、释义、例句），并标出所属的大类/小节。
